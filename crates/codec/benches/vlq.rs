use srcmap_codec::{Segment, SourceMapMappings, decode, encode};
...
fn make_decoded_synthetic_mappings() -> SourceMapMappings {
    let synthetic = make_synthetic_mappings();
    decode(&synthetic).unwrap()
}

fn make_decoded_realistic_mappings() -> SourceMapMappings {
